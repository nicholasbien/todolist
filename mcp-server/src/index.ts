    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => {
      return {
        tools: [
          ...
          {
            name: 'delete_todo',
            description: 'Close (soft-delete) a todo item. The item is marked as closed and appears in the completed list. Permanent deletion is only available via the frontend UI.',
            inputSchema: {
              type: 'object',
              properties: {
                id: { type: 'string', description: 'Todo ID' },
