      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <header className="border-b-2 border-purple-600 pb-6 mb-8">
            <h1 className="text-4xl font-bold text-purple-600 mb-2">Terms of Service</h1>
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-4">
              By creating an account or using todolist.nyc, you agree to these Terms and our <Link href="/privacy" className="text-purple-600 hover:underline">Privacy Policy</Link>. If you do not agree, please do not use our service.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">2. Description of Service</h2>
            <p className="mb-4">todolist.nyc provides an AI-powered task management application with:</p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">5. Content Ownership and License</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">6. AI Features and Third-Party Services</h2>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <li>See our <Link href="/privacy" className="text-purple-600 hover:underline">Privacy Policy</Link> for details on data sharing</li>
            </ul>

            <h2 className="text-2xl font-bold mt-8 mb-4">7. Service Availability and Modifications</h2>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">Your Right to Terminate:</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">Our Right to Terminate:</h3>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">11. Data Backup and Export</h2>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">15. Acknowledgment</h2>
            <p className="mb-4">
