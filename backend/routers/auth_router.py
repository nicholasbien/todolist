...
async def api_update_name(
    request: Request, name_request: UpdateNameRequest, current_user: dict = Depends(get_current_user)
):
    """Update user's first name."""
    logger.info(f"Update name request for user: {current_user['email']}, name: {name_request.first_name}")
